...
begin
  begin
    ords.delete_module(p_module_name => 'supplier_onboarding_v1');
  exception
    when others then
      null;
  end;
  ...
  ords.define_module(
    p_module_name => 'supplier_onboarding_v1',
    p_base_path => 'v1/',
    p_items_per_page => 25,
    p_status => 'PUBLISHED',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => '/');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
    p_pattern => '/',
    p_method => 'GET',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'health');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
    p_pattern => 'health',
    p_method => 'GET',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'requests');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
    p_pattern => 'requests',
    p_method => 'GET',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'requests/:request_id');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
  ...
  ords.define_handler(
    ...
    p_source => q'[
      begin
        ...
        owa_util.mime_header('application/json', true);
        htp.p('{"status":"updated"}');
      end;
    ]'
  );

  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'requests/:request_id/submit');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'requests/:request_id/documents');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'requests/:request_id/documents/:document_id');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'requests/:request_id/review');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
    ...
    p_source => q'[
      begin
        ...
        owa_util.mime_header('application/json', true);
        htp.p('{"status":"review_decision_recorded"}');
      end;
    ]'
  );

  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'requests/:request_id/justification-risk-adjustment');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
    ...
    p_source => q'[
      begin
        ...
        owa_util.mime_header('application/json', true);
        htp.p('{"status":"justification_risk_adjusted"}');
      end;
    ]'
  );

  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'requests/:request_id/ai-regeneration');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'requests/:request_id/retry');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'integration-logs');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'integration-jobs');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'integration-jobs/:job_id/claim');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
    ...
    p_source => q'[
      begin
        ...
        owa_util.mime_header('application/json', true);
        htp.p('{"status":"claimed"}');
      end;
    ]'
  );

  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'integration-jobs/:job_id/result');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'supplier-reference/batch');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
    ...
    p_source => q'[
      begin
        ...
        owa_util.mime_header('application/json', true);
        htp.p('{"status":"supplier_reference_received"}');
      end;
    ]'
  );

  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'risk-rules');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'risk-rules/:rule_code');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
    ...
    p_source => q'[
      begin
        ...
        owa_util.mime_header('application/json', true);
        htp.p('{"status":"risk_rule_updated"}');
      end;
    ]'
  );

  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'high-risk-countries');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
  ...
  ords.define_template(p_module_name => 'supplier_onboarding_v1', p_pattern => 'high-risk-countries/:country_code');
  ords.define_handler(
    p_module_name => 'supplier_onboarding_v1',
    ...
    p_source => q'[
      begin
        ...
        owa_util.mime_header('application/json', true);
        htp.p('{"status":"high_risk_country_updated"}');
      end;
    ]'
  );
